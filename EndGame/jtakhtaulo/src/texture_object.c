...
void init_render_objects(t_render_object ***objects, SDL_Renderer *renderer, int key) {
    ...
    if (key == 1) {
        ...
        platform (objects, renderer, 1030, 910, 100, 300, 6);
        platform (objects, renderer, 1230, 890, 100, 300, 7);
        platform (objects, renderer, 1430, 870, 100, 300, 8);
        platform (objects, renderer, 1630, 850, 100, 300, 9);
        platform (objects, renderer, 1830, 830, 100, 300, 10);
        door (objects, renderer, 1750, 780, 80, 40, 11);
    } else if (key == 2) {
        platform (objects, renderer, -30, 1010, 100, 300, 1);
        platform (objects, renderer, 230, 1010, 100, 300, 2);
        platform (objects, renderer, 490, 1010, 100, 300, 3);
        platform (objects, renderer, 750, 1010, 100, 300, 4);
        platform (objects, renderer, 1270, 850, 300, 200, 5);
        platform (objects, renderer, 1700, 750, 50, 200, 6);
        platform (objects, renderer, 1270, 600, 50, 200, 7);
        platform (objects, renderer, 1270, 400, 50, 200, 8);
        platform (objects, renderer, -30, 250, 100, 300, 9);
        platform (objects, renderer, 230, 250, 100, 300, 10);
        platform (objects, renderer, 490, 250, 100, 300, 11);
        platform (objects, renderer, 750, 250, 100, 300, 12);
        spike (objects, renderer, 700, 995, 20, 100, 13);
        spike (objects, renderer, 250, 235, 20, 100, 14);
        spike (objects, renderer, 350, 235, 20, 100, 15);
